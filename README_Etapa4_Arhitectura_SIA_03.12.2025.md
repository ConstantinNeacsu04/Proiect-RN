...
| Date generate prin simulare | sisteme de siguranta |Cod Python + grafice comparative |
...
care însă nu acoperea suficient variabilitatea condițiilor dintr-un mediu industrial real. 
Contribuția mea originală (peste 40% din dataset-ul final) constă în dezvoltarea 
și rularea unui pipeline de generare de date sintetice (`src/data_acquisition/synthetic_generator.py`)
 pentru a simula defectele specifice senzorilor optici din mașinile CNC.
